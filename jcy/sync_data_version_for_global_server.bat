...
echo =========================================
echo       D2R 同步数据版本编号 国际服
echo =========================================
echo.

:: =================【配置区域】=================
set "DOWNLOAD_URL=https://gist.githubusercontent.com/jcymeow/3781261d482005da57f7946321072e18/raw/3588f1a6a4481ee080c5e7edd6f7def6aa8bbd25/dataversionbuild.txt"
:: ==============================================
