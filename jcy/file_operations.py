...
class FileOperations:
    ...
    def toggle_skill_logo(self, isEnabled: bool = False):
        ...
        files_skill_logo = [
            ...
            r"data/hd/overlays/barbarian/frenzy.json",
            r"data/hd/overlays/common/battlecommand.json",
            r"data/hd/overlays/common/battleorders.json",
            r"data/hd/overlays/common/bloodlust_state.json",
            r"data/hd/overlays/common/impregnated.json",
            ...
            r"data/hd/overlays/druid/cyclonearmor_1back.json",
            r"data/hd/overlays/druid/feralrage_1.json",
            r"data/hd/overlays/druid/feralrage_2.json",
            r"data/hd/overlays/druid/feralrage_3.json",
            r"data/hd/overlays/druid/feralrage_4.json",
            r"data/hd/overlays/druid/feralrage_5.json",
            r"data/hd/overlays/necro/bonearmor_front.json",
            r"data/hd/overlays/sorceress/chillarmor.json",
            r"data/hd/overlays/sorceress/enchant.json",
            r"data/hd/overlays/sorceress/energyshield.json",
            r"data/hd/overlays/sorceress/frozenarmor.json",
            ...
            r"data/hd/overlays/warlock/psychicward.json",
            r"data/hd/overlays/warlock/warlockconsume.json",
        ]
    ...
    def switch_inventory_cube(self, value):
        ...
        try:
            # 1.jcy\jcy.mpq\data\global\ui\layouts\playerinventoryexpansionlayouthd.json
            json_data = None
            json_path = os.path.join(MOD_PATH, r"data/global/ui/layouts/playerinventoryexpansionlayouthd.json")
            with open(json_path, "r", encoding="utf-8") as f:
                json_data = json.load(f)
