    ...
    def select_game_setting(self, keys: list):
        ...
        _files = {
            ...
            "4": [
                ...
                r"data/hd/env/vis/chad_test_dawn1.json",
                r"data/hd/env/vis/chad_test_dawn2.json",
                r"data/hd/env/vis/chad_test_day.json",
                r"data/hd/env/vis/chad_test_dusk1.json",
                r"data/hd/env/vis/chad_test_dusk2.json",
                r"data/hd/env/vis/chad_test_night.json",
                r"data/hd/env/vis/denofevil_vis.json",
                r"data/hd/env/vis/diabloappears_vis.json",
                r"data/hd/env/vis/directshadowtest_dawn1.json",
                r"data/hd/env/vis/directshadowtest_dawn2.json",
                r"data/hd/env/vis/directshadowtest_day.json",
                r"data/hd/env/vis/directshadowtest_dusk1.json",
                r"data/hd/env/vis/directshadowtest_dusk2.json",
                r"data/hd/env/vis/directshadowtest_night.json",
                ...
                r"data/hd/env/vis/master_vis.json",
                r"data/hd/env/vis/spotlighttest_dawn1.json",
                r"data/hd/env/vis/spotlighttest_dawn2.json",
                r"data/hd/env/vis/spotlighttest_day.json",
                r"data/hd/env/vis/spotlighttest_dusk1.json",
                r"data/hd/env/vis/spotlighttest_dusk2.json",
                r"data/hd/env/vis/spotlighttest_night.json",
                r"data/hd/env/vis/test_vfx_dungeon_wr01_vis.json",
                r"data/hd/env/vis/ui_charactercreate_dawn1.json",
                r"data/hd/env/vis/ui_charactercreate_dawn2.json",
                r"data/hd/env/vis/ui_charactercreate_day.json",
                r"data/hd/env/vis/ui_charactercreate_dusk1.json",
                r"data/hd/env/vis/ui_charactercreate_dusk2.json",
                r"data/hd/env/vis/ui_charactercreate_night.json",
                r"data/hd/env/vis/ui_frontend_act1_vignette.json",
                r"data/hd/env/vis/ui_frontend_act2_vignette.json",
                r"data/hd/env/vis/ui_frontend_act3_vignette.json",
                r"data/hd/env/vis/ui_frontend_act4_vignette.json",
                r"data/hd/env/vis/ui_frontend_act5_vignette.json",
                r"data/hd/env/vis/ui_frontend_charactercreate.json",
                r"data/hd/env/vis/ui_frontend_lobby.json",
                r"data/hd/env/vis/vis_box_test_vfx_wr01_vis.json",
                r"data/hd/env/vis/vis_box_test_vfx_wr02_vis.json",
                r"data/hd/env/vis/vis_box_test_vfx_wr03_vis.json",
